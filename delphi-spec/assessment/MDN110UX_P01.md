# MDN110UX_P01 — NICU Quality Check Print Report

## Category

- **Form/UI**: Paired MDN110UX_P01.dfm exists (31178 lines). QuickReport print form for NICU quality check data with JPEG image support.
- **Third-party**: QuickReport (TQuickRep, TQRBand, TQRLabel, TQRShape, TQRImage), Vcl.Imaging.jpeg.
- **OS/Win32-specific**: Uses Windows unit.

## Public Interface

### Class: TMDN110FX_P01 (inherits TForm)
...
N/A -- no direct middleware calls. Print-only form populated by calling form (MDN110UX).
...
Key components from MDN110UX_P01.dfm (31178 lines):
- **TQuickRep**: qr_QualityCheck — main NICU quality check report
- **TQRBand**: multiple bands for report sections
- **TQRLabel**: 1000+ labels for NICU quality check fields (Day/Evening/Night)
- **TQRShape**: 1000+ shapes for report grid lines
- **TQRImage**: images for report headers

## Behavioral .dfm Properties

DFM file: 31178 lines. Minimum threshold: 63 rows.
...
| qrlb_D_01 | AutoSize | False | Day NICU quality check field 01 |
| qrlb_D_02 | AutoSize | False | Day NICU quality check field 02 |
| qrlb_D_03 | AutoSize | False | Day NICU quality check field 03 |
| qrlb_D_04 | AutoSize | False | Day NICU quality check field 04 |
| qrlb_D_05 | AutoSize | False | Day NICU quality check field 05 |
| qrlb_D_06 | AutoSize | False | Day NICU quality check field 06 |
| qrlb_D_07 | AutoSize | False | Day NICU quality check field 07 |
| qrlb_D_08 | AutoSize | False | Day NICU quality check field 08 |
| qrlb_E_01 | AutoSize | False | Evening NICU quality check field 01 |
| qrlb_E_02 | AutoSize | False | Evening NICU quality check field 02 |
| qrlb_E_03 | AutoSize | False | Evening NICU quality check field 03 |
| qrlb_E_04 | AutoSize | False | Evening NICU quality check field 04 |
| qrlb_E_05 | AutoSize | False | Evening NICU quality check field 05 |
| qrlb_E_06 | AutoSize | False | Evening NICU quality check field 06 |
| qrlb_E_07 | AutoSize | False | Evening NICU quality check field 07 |
| qrlb_E_08 | AutoSize | False | Evening NICU quality check field 08 |
| qrlb_N_01 | AutoSize | False | Night NICU quality check field 01 |
| qrlb_N_02 | AutoSize | False | Night NICU quality check field 02 |
| qrlb_N_03 | AutoSize | False | Night NICU quality check field 03 |
| qrlb_N_04 | AutoSize | False | Night NICU quality check field 04 |
| qrlb_N_05 | AutoSize | False | Night NICU quality check field 05 |
| qrlb_N_06 | AutoSize | False | Night NICU quality check field 06 |
| qrlb_N_07 | AutoSize | False | Night NICU quality check field 07 |
| qrlb_N_08 | AutoSize | False | Night NICU quality check field 08 |
...
|----------|------|---------|------------|
| MDN110FX_P01 | TMDN110FX_P01 | MDN110UX (calling form) | FormCreate (implicit), FormDestroy (set to Nil) |
| IsLastPage | Integer | Print logic | MDN110UX |
| LastDateYn | String | Print logic | MDN110UX |
...
1. This is the NICU variant of MDN110UV_P01 (ICU quality check print). The report layout includes NICU-specific quality check fields.
